...
public:
    ...
    static void RenderToTarget(const RenderTarget::Ptr target, const Material::Ptr material, const bool &clearColor = true, const bool &clearDepth = true);
...
private:
    ...
    static Material::Ptr CopyDepthMat;
};
