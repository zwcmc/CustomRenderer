...
public:
    ...
    static glTFRenderer::Ptr loadglTFFile(const std::string &filePath, Shader::Ptr shader);
...
private:
    ...
    static void loadglTFNode(const tinygltf::Node &inputNode, const tinygltf::Model &input, glTFRenderer::Ptr renderer, glTFRenderer::glTFNode::Ptr parent, Shader::Ptr shader);
